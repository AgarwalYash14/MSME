        ...
        <>
            <div className={styles.homepage}>
                ...
                <div className={styles.benefits}>
                    <div className={styles.benefits_heading}>
                    ...
                    <div className={styles.benefits_icons}>
                        <div className={styles.b1}>
                            ...
                            <h3>Time Savings</h3>
                            <p>
                                Efficiently manage your catalog, saving valuable
                                time and resources with streamlined processes
                                and automation
                            </p>
                        </div>
                        ...
                        <div className={styles.b1}>
                            ...
                            <p>
                                Ensure product accuracy and consistency through
                        ...
                        <div className={styles.b1}>
                            ...
                            <p>
                                Foster real-time collaboration among
                                stakeholders, enhancing productivity and
                                decision-making.
                            </p>
                        </div>
                        ...
                        <div className={styles.b1}>
                            ...
                            <p>
                                Seamlessly integrate with e-commerce platforms
                        ...
                        <div className={styles.b1}>
                            ...
                            <p>
                                Join a vibrant community of industry
                                professionals for networking and knowledge.
                            </p>
                        </div>
                    </div>
                </div>
